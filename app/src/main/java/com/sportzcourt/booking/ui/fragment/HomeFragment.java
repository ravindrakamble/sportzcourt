...
import com.sportzcourt.booking.ui.adapter.HomeViewAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<Sport> sportsList = new ArrayList<>(5);
        for(int i = 0; i < 5; i++){
            Sport sport  = new Sport();
            sportsList.add(sport);
        }
        homeViewAdapter = new HomeViewAdapter(getActivity(), sportsList);
